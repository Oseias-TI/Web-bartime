...
Back-end API do sistema **Bartime**, uma plataforma completa para gerenciamento de barbearias. Esta API fornece todos os recursos necessários para agendamentos, pagamentos, relatórios, notificações e muito mais.
...
```bash
git clone https://github.com/Oseias-TI/BackEnd-Bartime.git
cd BackEnd-Bartime
```
