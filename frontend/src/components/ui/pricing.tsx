      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:2 gap-4">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              `rounded-2xl border-[1px] p-6 bg-white/5 backdrop-blur-md text-white text-center lg:flex lg:flex-col lg:justify-center relative`,
          ...
          >
            ...
            <div className="flex-1 flex flex-col">
              ...
              <ul className="mt-5 gap-2 flex flex-col">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    ...
                    <span className="text-left text-neutral-200">{feature}</span>
                  </li>
                ))}
              </ul>
              ...
              <Link
                href={plan.href}
                className={cn(
                  "inline-flex items-center justify-center whitespace-nowrap rounded-lg group relative w-full gap-2 overflow-hidden text-lg font-semibold tracking-tighter border border-white/10 h-11 px-8",
